  ...
  public void run() {
    ...
    try{
      ...
      while(this.registeredToRecieve == false){
        ...
        if(clientSentence.indexOf("REGISTER TORECV")!=-1 && Pattern.matches("^[a-zA-Z0-9]+$", clientSentence.split("REGISTER TORECV ")[1])){
          ...
          TCPServer.tableIn.put(clientSentence.split("REGISTER TOSEND ")[1], in);
          TCPServer.tableOut.put(clientSentence.split("REGISTER TOSEND ")[1], out);
      ...
      //   if(TCPServer.table.containsKey(recipient)){h3 = true;}
  ...
  public void run() {
    ...
    try{
      ...
      while(!exitApp){
        ...
        if(TCPServer.tableOut.containsKey(recipient)){h3 = true;}
